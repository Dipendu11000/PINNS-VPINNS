...
# def plot_prediction(X, Y, y_pred, output_path, epoch):
#     """
...
#     plt.contourf(X, Y, y_pred, cmap='jet', levels=100)
#     plt.colorbar()
#     plt.title('VPINNS_Prediction')
    
#     plt.xlabel('x')
#     plt.ylabel('y')
#     plt.savefig(f"{output_path}/prediction_epoch_{epoch + 1}.png")
#     plt.close()
# -
